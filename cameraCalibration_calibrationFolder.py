...
parser.add_argument('--calibrationFolder', nargs='?', default="E:\\output\\Data\\Group9Calibration\\")
parser.add_argument('--jsonPath', nargs='?', default="E:\\output\\Data\\Group_09-sub2.json")
parser.add_argument('--initialFrame', nargs='?', default=300)
...
paths = sorted(os.listdir(args.calibrationFolder))
images = []
for imname in paths:
    im = cv2.imread(f"{args.calibrationFolder}\\{imname}", 1)
    images.append(im)   
